...
let CONTRACT_ID_ORACLE = Load.computeContractId "output/Oracle.fst"
...
let ocMain, ocCost = Load.extractMainAndCost "output/Oracle.dll"
...
let _ =
   ...
   let res1 = Oracle.hashCommitData {commit = commit1 ; oraclePubKey = pk1 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashCommitData {commit = commit2 ; oraclePubKey = pk2 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
...
let _ =
   ...
   let res1 = Oracle.hashCommitData {commit = commit ; oraclePubKey = pk1 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashCommitData {commit = commit ; oraclePubKey = pk2 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   if pk1 = pk2 then failwith "error: pk1 = pk2. this should rarely happen - please run the test again"
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashCommitData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashCommitData {commit = commit2 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashCommitData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = Some 1UL} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashCommitData {commit = commit1 ; oraclePubKey = pk ; feeAsset = fsToFstAsset (Types.Asset (CONTRACT_ID_OTHER, Hash.zero)) ; feeAmount = Some 1UL} |> Zen.Cost.Realized.__force
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashCommitData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = Some 1UL} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashCommitData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = Some 2UL} |> Zen.Cost.Realized.__force
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashAttestData {commit = commit1 ; oraclePubKey = pk1 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashAttestData {commit = commit2 ; oraclePubKey = pk2 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   if pk1 = pk2 then failwith "error: pk1 = pk2. this should rarely happen - please run the test again"
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashAttestData {commit = commit ; oraclePubKey = pk1 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashAttestData {commit = commit ; oraclePubKey = pk2 ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   if pk1 = pk2 then failwith "error: pk1 = pk2. this should rarely happen - please run the test again"
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashAttestData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashAttestData {commit = commit2 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = None} |> Zen.Cost.Realized.__force
   if res1 = res2 then printfn "  ⛔ FAILED - different data but same hash"
   else printfn "  ✅ PASSED"
...
let _ =
   ...
   let res1 = Oracle.hashAttestData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = Some 1UL} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashAttestData {commit = commit1 ; oraclePubKey = pk ; feeAsset = fsToFstAsset (Types.Asset (CONTRACT_ID_ORACLE, Hash.zero)) ; feeAmount = Some 1UL} |> Zen.Cost.Realized.__force
...
let _ =
   ...
   let res1 = Oracle.hashAttestData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = Some 1UL} |> Zen.Cost.Realized.__force
   let res2 = Oracle.hashAttestData {commit = commit1 ; oraclePubKey = pk ; feeAsset = Zen.Asset.zenAsset ; feeAmount = Some 2UL} |> Zen.Cost.Realized.__force
   if res1 <> res2 then printfn "  ⛔ FAILED - this difference shouldn't affect hash"
   else printfn "  ✅ PASSED"
